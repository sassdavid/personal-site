...
> **Note**: This guide was originally written for the template this site is based on ([mldangelo/personal-site](https://github.com/mldangelo/personal-site)).
> The customization steps below have already been applied to David Sass-Kovacs's personal site.
