...
describe('readImageSize', () => {
  ...
  // Every WebP variant is decoded from a synthetic buffer in the
  // `parseImageSize` suite above, and reading from `public/` is covered by the
  // og.png case — so there is nothing left for a real .webp fixture to prove.
