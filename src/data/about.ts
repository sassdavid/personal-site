...
As a Senior DevOps Engineer at [Loxon](https://loxon.eu/), I play a key role in designing, implementing, and maintaining the infrastructure and deployment pipelines
...
[Terraform](https://www.terraform.io/), [Terragrunt](https://terragrunt.gruntwork.io/), [Helm](https://helm.sh/),
[Kubernetes](https://kubernetes.io/), [AWS](https://aws.amazon.com/), and [Amazon EKS](https://aws.amazon.com/eks/).
Additionally, I have experience with [Python](https://www.python.org/) for scripting and automation,
as well as tools like [Argo CD](https://argo-cd.readthedocs.io/en/stable/), [Jenkins](https://www.jenkins.io/), and [Docker](https://www.docker.com/)
...
In my role as a DevOps Engineer at [Loxon](https://loxon.eu/), I primarily focus on optimizing and managing our infrastructure in AWS.
...
Another crucial aspect of my work at [Loxon](https://loxon.eu/) has been developing strong relationships with clients. Through regular
...
Furthermore, my experience at [Loxon](https://loxon.eu/) has allowed me to gain hands-on experience in implementing enterprise-grade products,
...
Overall, my time at [Loxon](https://loxon.eu/) has been instrumental in shaping my professional development and has given me a solid foundation
